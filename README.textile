...
h4. "Devise and Pundit and Rails":https://github.com/RailsApps/rails-devise-pundit

See the example application "Devise and Pundit and Rails":https://github.com/RailsApps/rails-devise-pundit for use with Rails 4.1. The rails3-bootstrap-devise-cancan example application is outdated and has been replaced!

"CanCan":https://github.com/ryanb/cancan is no longer maintained. Instead, use "Pundit":https://github.com/elabs/pundit for authorization.
...
<pre>
PortalCTO::Application.config.secret_token = '...some really long, random string...'
</pre>
